import numpy as np
# from mjrl.mjrl.utils.fc_network import FCNetwork
...
class MLP:
    ...
    def get_action(self, observation):
        ...
        # noise = 1.0/(1.0+np.exp(-self.log_std_val)) if self.log_std_val.any() >= 0.0 else np.exp(self.log_std_val)/(1.0+np.exp(self.log_std_val))
