...
def train_variant_agent(job_name, agent,
                seed = 0,
                niter = 101,
                gamma = 0.995,
                gae_lambda = None,
    ...
    reward_conf = "npoint{}_ntouch{}_random{}".format(env_kwargs["npoint_r_factor"], env_kwargs["ntouch_r_factor"], env_kwargs["random_r_factor"])
